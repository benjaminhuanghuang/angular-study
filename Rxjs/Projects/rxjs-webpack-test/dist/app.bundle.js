...
(0,rxjs__WEBPACK_IMPORTED_MODULE_0__.of)(1, 2, 3).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(function (x) {
  return x * x;
...
(0,rxjs__WEBPACK_IMPORTED_MODULE_2__.fromEvent)(document, 'click').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.scan)(function (count) {
  return count + 1;
}, 0)).subscribe(function (count) {
  console.log("Clicked ".concat(count, " times"));
});
var arraySource = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)([1, 2, 3, 4, 5]);
arraySource.subscribe(function (val) {
...
observable.subscribe(function (v) {
  return console.log("value: ".concat(v));
});
})();
