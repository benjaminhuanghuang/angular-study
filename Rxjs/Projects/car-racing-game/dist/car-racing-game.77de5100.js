...
exports.player = exports.car = exports.levelDuration = exports.gameWidth = exports.gameHeight = void 0;
exports.gameHeight = 10;
exports.gameWidth = 6;
exports.levelDuration = 500;
exports.car = 1;
exports.player = 2;
...
var handleScoreIncrease = function handleScoreIncrease(_a) {
  var state = _a[0],
    road = _a[1],
    player = _a[2];
  return !road.cars[0].scored && road.cars[0].y !== player.y && road.cars[0].x === constants_1.gameHeight - 1 ? (road.cars[0].scored = true, state.score += 1) : rxjs_1.noop;
};
var handleCollision = function handleCollision(_a) {
  var state = _a[0],
    road = _a[1],
    player = _a[2];
  return road.cars[0].x === constants_1.gameHeight - 1 && road.cars[0].y === player.y ? state.lives -= 1 : rxjs_1.noop;
};
var updateSpeed = function updateSpeed(_a, gameSpeed) {
  var state = _a[0];
  return state.duration -= 10, state.duration < 0 ? (state.duration = constants_1.levelDuration * state.level, state.level++, state.interval -= state.interval > 60 ? 20 : 0, gameSpeed.next(state.interval)) : function () {};
};
var updateState = function updateState(gameSpeed) {
  return function (_, game) {
    return handleScoreIncrease(game), handleCollision(game), updateSpeed(game, gameSpeed), game;
  };
};
exports.updateState = updateState;
},{"rxjs":"node_modules/rxjs/dist/esm5/index.js","./constants":"constants.ts"}],"html-renderer.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderGameOver = exports.render = void 0;
var constants_1 = require("./constants");
var createElem = function createElem(column) {
  return function (elem) {
    return elem.style.display = 'inline-block', elem.style.marginLeft = '3px', elem.style.height = '12px', elem.style.width = '6px', elem.style.borderRadius = '40%', elem.style['background-color'] = column === constants_1.car ? 'green' : column === constants_1.player ? 'blue' : 'white', elem;
...
var render = function render(_a) {
  ...
  if (gameElement) {
    (function (renderFrame) {
      return road.cars.forEach(function (c) {
        return renderFrame[c.x][c.y] = constants_1.car;
      }), gameElement.innerHTML = "Score: ".concat(state.score, " Lives: ").concat(state.lives, " Level: ").concat(state.level), renderFrame[constants_1.gameHeight - 1][playerPosition.y] = constants_1.player, renderFrame.forEach(function (r) {
    ...
    })(Array(constants_1.gameHeight).fill(0).map(function (e) {
      return Array(constants_1.gameWidth).fill(0);
    }));
  }
};
...
var randomCar = function randomCar() {
  return car(0, Math.floor(Math.random() * Math.floor(constants_1.gameWidth)));
};
var gameSpeed$ = new rxjs_1.BehaviorSubject(200);
var road$ = gameSpeed$.pipe((0, operators_1.switchMap)(function (i) {
  return (0, rxjs_1.interval)(i).pipe((0, operators_1.scan)(function (road, _) {
    return road.cars = road.cars.filter(function (c) {
      return c.x < constants_1.gameHeight - 1;
    }), road.cars[0].x === constants_1.gameHeight / 2 ? road.cars.push(randomCar()) : rxjs_1.noop, road.cars.forEach(function (c) {
      return c.x++;
    }), road;
  }, {
    cars: [randomCar()]
...
var keys$ = (0, rxjs_1.fromEvent)(document, 'keyup').pipe((0, operators_1.startWith)({
  code: ''
}), (0, operators_1.pluck)('code'));
var player$ = keys$.pipe((0, operators_1.scan)(function (player, key) {
  return player.y += key === 'ArrowLeft' && player.y > 0 ? -1 : key === 'ArrowRight' && player.y < constants_1.gameWidth - 1 ? 1 : 0, player;
}, {
  y: 0
}));
var state$ = (0, rxjs_1.of)({
  score: 1,
  lives: 3,
  level: 1,
  duration: constants_1.levelDuration,
  interval: 200
});
var isNotGameOver = function isNotGameOver(_a) {
  var state = _a[0];
  return state.lives > 0;
};
var game$ = (0, rxjs_1.combineLatest)(state$, road$, player$).pipe((0, operators_1.scan)((0, state_1.updateState)(gameSpeed$)), (0, operators_1.tap)(html_renderer_1.render), (0, operators_1.takeWhile)(isNotGameOver), (0, operators_1.finalize)(html_renderer_1.renderGameOver));
game$.subscribe();
},{"rxjs":"node_modules/rxjs/dist/esm5/index.js","rxjs/operators":"node_modules/rxjs/dist/esm5/operators/index.js","./constants":"constants.ts","./state":"state.ts","./html-renderer":"html-renderer.ts"}],"../../../../Users/benjhuang/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../Users/benjhuang/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
//# sourceMappingURL=/car-racing-game.77de5100.js.map