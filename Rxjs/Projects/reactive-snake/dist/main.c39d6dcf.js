...
},{"tslib":"node_modules/tslib/tslib.es6.js","./isFunction":"node_modules/rxjs/dist/esm5/internal/util/isFunction.js"}],"../../../../Users/benjhuang/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
exports.DIRECTIONS = exports.FPS = exports.SPEED = exports.POINTS_PER_APPLE = exports.APPLE_COUNT = exports.SNAKE_LENGTH = exports.CANVAS_HEIGHT = exports.CANVAS_WIDTH = exports.CELL_SIZE = exports.GAP_SIZE = exports.ROWS = exports.COLS = void 0;
exports.COLS = 30;
exports.ROWS = 30;
exports.GAP_SIZE = 1;
exports.CELL_SIZE = 10;
exports.CANVAS_WIDTH = exports.COLS * (exports.CELL_SIZE + exports.GAP_SIZE);
exports.CANVAS_HEIGHT = exports.ROWS * (exports.CELL_SIZE + exports.GAP_SIZE);
exports.SNAKE_LENGTH = 5;
exports.APPLE_COUNT = 2;
exports.POINTS_PER_APPLE = 1;
exports.SPEED = 200;
exports.FPS = 60;
exports.DIRECTIONS = {
  37: {
...
exports.checkCollision = exports.getRandomPosition = exports.renderGameOver = exports.renderSnake = exports.renderApples = exports.renderScore = exports.renderScene = exports.createCanvasElement = void 0;
...
function renderScore(ctx, score) {
  var textX = constants_1.CANVAS_WIDTH / 2;
  var textY = constants_1.CANVAS_HEIGHT / 2;
...
function renderApples(ctx, apples) {
  apples.forEach(function (apple) {
    return paintCell(ctx, apple, 'red');
  });
}
exports.renderApples = renderApples;
function renderSnake(ctx, snake) {
  snake.forEach(function (segment, index) {
    return paintCell(ctx, wrapBounds(segment), getSegmentColor(index));
  });
}
exports.renderSnake = renderSnake;
function renderGameOver(ctx) {
  ctx.fillStyle = 'rgba(255, 255, 255, 0.7)';
  ctx.fillRect(0, 0, constants_1.CANVAS_WIDTH, constants_1.CANVAS_HEIGHT);
  var textX = constants_1.CANVAS_WIDTH / 2;
  var textY = constants_1.CANVAS_HEIGHT / 2;
...
function getRandomPosition(snake) {
  ...
  var position = {
    x: getRandomNumber(0, constants_1.COLS - 1),
    y: getRandomNumber(0, constants_1.ROWS - 1)
  };
...
function isEmptyCell(position, snake) {
  return !snake.some(function (segment) {
    return checkCollision(segment, position);
  });
}
...
function wrapBounds(point) {
  point.x = point.x >= constants_1.COLS ? 0 : point.x < 0 ? constants_1.COLS - 1 : point.x;
  point.y = point.y >= constants_1.ROWS ? 0 : point.y < 0 ? constants_1.ROWS - 1 : point.y;
  return point;
}
function paintCell(ctx, point, color) {
  var x = point.x * constants_1.CELL_SIZE + point.x * constants_1.GAP_SIZE;
  var y = point.y * constants_1.CELL_SIZE + point.y * constants_1.GAP_SIZE;
  ctx.fillStyle = color;
  ctx.fillRect(x, y, constants_1.CELL_SIZE, constants_1.CELL_SIZE);
}
},{"./constants":"constants.ts"}],"utils.ts":[function(require,module,exports) {
"use strict";
...
exports.generateApples = exports.generateSnake = exports.eat = exports.move = exports.nextDirection = exports.isGameOver = void 0;
...
function isGameOver(scene) {
  ...
  return body.some(function (segment) {
    return (0, canvas_1.checkCollision)(segment, head);
  });
}
exports.isGameOver = isGameOver;
/*
    check if the next direction is opposite to the previous,
    if yes, then return the previous direction, otherwise return the next direction
*/
...
function eat(apples, snake) {
  ...
  for (var i = 0; i < apples.length; i++) {
    if ((0, canvas_1.checkCollision)(apples[i], head)) {
      apples.splice(i, 1);
      return __spreadArray(__spreadArray([], apples, true), [(0, canvas_1.getRandomPosition)(snake)], false);
    }
  }
  return apples;
}
...
function generateSnake() {
  var snake = [];
  for (var i = constants_1.SNAKE_LENGTH - 1; i >= 0; i--) {
    snake.push({
      x: i,
      y: 0
    });
...
function generateApples() {
  var apples = [];
  for (var i = 0; i < constants_1.APPLE_COUNT; i++) {
    apples.push((0, canvas_1.getRandomPosition)());
  }
  return apples;
}
exports.generateApples = generateApples;
},{"./canvas":"canvas.ts","./constants":"constants.ts"}],"main.ts":[function(require,module,exports) {
"use strict";
 ...
 */
var canvas = (0, canvas_1.createCanvasElement)();
var ctx = canvas.getContext('2d');
document.body.appendChild(canvas);
/**
 * Starting values
 */
var INITIAL_DIRECTION = constants_1.DIRECTIONS[types_1.Key.RIGHT];
var ticks$ = (0, rxjs_1.interval)(constants_1.SPEED);
var click$ = (0, rxjs_1.fromEvent)(document, 'click');
var keydown$ = (0, rxjs_1.fromEvent)(document, 'keydown');
function createGame(fps$) {
  var direction$ = keydown$.pipe((0, operators_1.map)(function (event) {
    return constants_1.DIRECTIONS[event.key];
  }), (0, operators_1.filter)(function (direction) {
    return !!direction;
  }),
  // filter the key that is not in the DIRECTIONS
  (0, operators_1.startWith)(INITIAL_DIRECTION),
  //
  (0, operators_1.scan)(utils_1.nextDirection),
  // ignore the opposite direction
  (0, operators_1.distinctUntilChanged)());
  var length$ = new rxjs_1.BehaviorSubject(constants_1.SNAKE_LENGTH);
  var snakeLength$ = length$.pipe((0, operators_1.scan)(function (step, snakeLength) {
    return snakeLength + step;
  }), (0, operators_1.share)());
  var score$ = snakeLength$.pipe((0, operators_1.startWith)(0), (0, operators_1.scan)(function (score, _) {
    return score + constants_1.POINTS_PER_APPLE;
  }));
  var snake$ = ticks$.pipe(
  //withLatestFrom(direction$, snakeLength$, (_, direction, snakeLength) => [direction, snakeLength]),
  (0, operators_1.withLatestFrom)(direction$, snakeLength$, function (_, direction, snakeLength) {
    return [direction, snakeLength];
  }), (0, operators_1.scan)(utils_1.move, (0, utils_1.generateSnake)()), (0, operators_1.share)());
  var apples$ = snake$.pipe((0, operators_1.scan)(utils_1.eat, (0, utils_1.generateApples)()), (0, operators_1.distinctUntilChanged)(), (0, operators_1.share)());
  var appleEaten$ = apples$.pipe((0, operators_1.skip)(1), (0, operators_1.tap)(function () {
    return length$.next(constants_1.POINTS_PER_APPLE);
  })).subscribe();
  var scene$ = (0, rxjs_1.combineLatest)(snake$, apples$, score$, function (snake, apples, score) {
    return {
      snake: snake,
      apples: apples,
      score: score
  ...
  return fps$.pipe((0, operators_1.withLatestFrom)(scene$, function (_, scene) {
    return scene;
  }));
}
var game$ = (0, rxjs_1.of)('Start Game').pipe((0, operators_1.map)(function () {
  return (0, rxjs_1.interval)(1000 / constants_1.FPS, rxjs_1.animationFrameScheduler);
}), (0, operators_1.switchMap)(createGame), (0, operators_1.takeWhile)(function (scene) {
  return !(0, utils_1.isGameOver)(scene);
}));
var startGame = function startGame() {
  return game$.subscribe({
    next: function next(scene) {
      if (ctx != null) {
        (0, canvas_1.renderScene)(ctx, scene);
      }
    },
    complete: function complete() {
      if (ctx != null) {
        (0, canvas_1.renderGameOver)(ctx);
      }
      click$.pipe((0, operators_1.first)()).subscribe(startGame);
    }
  });
};
startGame();
},{"rxjs":"node_modules/rxjs/dist/esm5/index.js","rxjs/operators":"node_modules/rxjs/dist/esm5/operators/index.js","./constants":"constants.ts","./types":"types.ts","./canvas":"canvas.ts","./utils":"utils.ts"}],"../../../../Users/benjhuang/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../Users/benjhuang/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.ts"], null)
