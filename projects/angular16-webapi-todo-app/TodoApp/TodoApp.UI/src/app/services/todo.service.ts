...
export class TodoService {
  baseApiUrl: string = 'https://localhost:7284/';
  ...
  undoDeletedTodo(id: string): Observable<Todo> {
    return this.http.put<Todo>(this.baseApiUrl + 'api/todo/undo-deleted-todo/' + id, null);
  }
}
